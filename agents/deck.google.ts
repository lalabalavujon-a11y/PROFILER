  ...
  return [
    {
      ...
      speakerNotes:
        "Welcome and introduction to the power of lead reconnaissance.",
    },
    {
      title: "The Lead Generation Problem",
      content: [
        "90% of leads are never properly qualified",
        "Manual processes waste 60% of sales time",
        "Poor lead data costs $1M+ annually",
      ],
      speakerNotes:
        "Establish the problem that resonates with the audience's pain points.",
    },
    {
      ...
      speakerNotes:
        "Present the solution with focus on automation and AI capabilities.",
    },
    {
      title: "Live Demo",
      content: [
        ...
        "Generated segments and messaging",
      ],
